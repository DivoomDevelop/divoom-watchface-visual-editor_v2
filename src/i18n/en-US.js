const enUS = Object.freeze({
  ...
  "editor.asset.title": "Local animation asset (JPEG / WEBP / GIF)",
  "editor.asset.fileInfoTitle": "Selected File Info",
  "editor.asset.ruleInfoTitle": "Animation Rule",
  "editor.asset.pickHint": "Pick a local file (JPEG / WEBP / GIF); type is detected from content, not the extension.",
  ...
  "editor.asset.support": "Supported: JPEG, WEBP, GIF (detected via file signature).",
  ...
  "editor.asset.formatError": "Only JPEG, WEBP, or GIF content is supported (could not detect one of these).",
  ...
  "template.btn.sync": "Update templates",
  "template.btn.syncTitle": "Re-scan Divoom China store API for pending dials; npm run dev to write files; fonts still via LAN device",
  "template.btn.viewPending": "Pending ({count})",
  "template.btn.viewPendingTitle": "View last scan results without re-scanning",
  "template.sync.needDevice": "Select a LAN device in the top bar to download fonts and other device assets.",
  "template.sync.needDeviceId": "Select a LAN device in the top bar (for DeviceId), or ensure a device ID is saved locally.",
  "template.sync.needDevServer": "Template sync requires npm run dev (local write API).",
  "template.sync.scanning": "Scanning for template updates: {message}",
  "template.sync.running": "Updating templates: {message}",
  "template.sync.done": "Templates updated: {categories} categories, {clocks} dials; configs written {configsWritten}, skipped {configsSkipped}; assets {assetsWritten} ok / {assetsFailed} failed; fonts missing {fontsRequested}, downloaded {fontsWritten} ok / {fontsFailed} failed.",
  "template.sync.failed": "Template sync failed: {message}",
  "template.sync.confirm": "Fetch all store categories from the connected device and write to public/template. This may take a while. Continue?",
  "template.pending.title": "Templates to download",
  "template.pending.back": "Back to templates",
  "template.pending.hint": "{count} dial(s) pending in this category. Single-click to preview when already local; use Download to install config, assets, and fonts.",
  "template.pending.restored": "Restored last scan ({time}). Click Update templates to scan again.",
  "template.pending.toolbarHint": "Pending downloads: preview works for dials already on disk; download first for new ones.",
  "template.pending.empty": "No templates pending download.",
  "template.pending.categoryEmpty": "No pending items in this category.",
  "template.pending.scanning": "Scanning device store: {message}",
  "template.pending.scanFailed": "Failed to scan pending templates: {message}",
  "template.pending.noneUpToDate": "Local template library is up to date with the device store.",
  "template.pending.download": "Download",
  "template.pending.installed": "In library",
  "template.pending.reasonMissing": "Missing locally",
  "template.pending.reasonOutdated": "Update available",
  "template.pending.downloadingTitle": "Downloading: {name}",
  "template.pending.downloadDone": "Dial {id} added to local templates: {name}",
  "template.pending.downloadFailed": "Download failed: {message}",
  "template.pending.previewNeedDownload": "Not downloaded yet — click Download first.",
  "template.pending.prefetchWait": "Waiting for device store cache (~{seconds}s left)…",
  "template.pending.catalogFallback": "Device store cache empty — scanning with local category catalog…",
  "template.pending.catalogSourceHint": "Catalog source: {source} (not live device store; only checking local .cfg files)",

  "font.btn.sync": "Update fonts",
  "font.btn.syncTitle": "Scan Divoom China store for new fonts (GetTimeDialFontV2); npm run dev required to write files",
  "font.btn.viewPending": "Pending fonts ({count})",
  "font.btn.viewPendingTitle": "View last font scan without re-scanning",
  "font.pending.title": "Fonts to download",
  "font.pending.hint": "{count} font(s) available. Check items and click Download selected.",
  "font.pending.restored": "Restored last scan ({time}). Click Update fonts to scan again.",
  "font.pending.empty": "Local font library is up to date.",
  "font.pending.noneUpToDate": "All fonts are already downloaded. No updates available.",
  "font.pending.scanning": "Scanning font catalog: {message}",
  "font.pending.scanFailed": "Font scan failed: {message}",
  "font.pending.selectAll": "Select all",
  "font.pending.selectNone": "Select none",
  "font.pending.downloadSelected": "Download selected",
  "font.pending.cancel": "Close",
  "font.pending.reasonMissing": "Missing metadata",
  "font.pending.reasonFileMissing": "Missing font file",
  "font.pending.reasonOutdated": "CDN URL updated",
  "font.pending.downloading": "Downloading fonts…",
  "font.pending.downloadDone": "Fonts done: {written} ok, {failed} failed.",
  "font.pending.downloadFailed": "Font download failed: {message}",
  ...
  "lan.err.noDeviceId": "No LAN device selected or missing DeviceId; cannot send JSON commands.",
